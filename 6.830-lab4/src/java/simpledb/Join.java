        ...
        while(true)
        {
            while(child2.hasNext())
            {
                ...
                if(p.filter(t1,t2))
                {
                    ...
                    for(;index<t1.getTupleDesc().numFields();++index)
                        t.setField(index,t1.getField(index));
                    for(;index2<t2.getTupleDesc().numFields();++index2)
                        t.setField(index+index2,t2.getField(index2));
                    return t;
                }
