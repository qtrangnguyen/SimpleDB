...
public class LockingTest extends TestUtil.CreateHeapFile {
  ...
  public void metaLockTester(
	  ...
	  System.out.println(tid1 + " is getting page " + pid1
				+ " with permissions " + perm1);
		bp.getPage(tid1, pid1, perm1);
		System.out
				.println(tid1 + " got " + pid1 + " with permissions " + perm1);
		System.out.println(tid2 + " is getting page " + pid2
				+ " with permissions " + perm2);
